                ...
                >
                  <div style={{ flex: 1, fontSize: 11, color: "#334155", lineHeight: 1.4 }}>
                    ...
                    <div style={{ color: "#64748b" }}>
                      Scannez ce QR Code avec votre smartphone pour accéder à votre facture et régler instantanément via <strong>Mixx by Yas</strong> ou <strong>Moov Money</strong>.
                    </div>
